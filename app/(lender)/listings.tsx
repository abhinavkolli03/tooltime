    ...
    return (
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.addBtn} onPress={() => Alert.alert('Coming Soon', 'List a Tool form is coming soon!')}>
            ...
            {listings.length === 0 ? (
                <View style={styles.emptyContainer}>
                    ...
                    <TouchableOpacity style={styles.primaryBtn} onPress={() => Alert.alert('Coming Soon', 'List a Tool form is coming soon!')}>
